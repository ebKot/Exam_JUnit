...
public class CreateIssueDialogElements {
    ...
    // Поле Тема
    public static SelenideElement subjectField = $x("//label[text()='Тема ']//following-sibling::input");
    ...
    // Исправить в версиях
    public static SelenideElement fixVersion2_0 = $x("//div[contains(@class,'versionspicker')]//child::label[@for='fixVersions']//following-sibling::select//descendant::option[contains(text(),'Version 2.0')]");
    ...
    // Поле Окружение
    public static SelenideElement environmentFrame = $x("//div[@class='content']//descendant::label[text()='Окружение']//following-sibling::div[@field-id='environment']//descendant::iframe");
    public static SelenideElement environmentField = $x("//body[@data-id='mce_6']//p");

    // Затронуты версии
    public static SelenideElement affectedVersion2_0 = $x("//div[contains(@class,'versionspicker')]//child::label[@for='versions']//following-sibling::select//descendant::option[contains(text(),'Version 2.0')]");
